---
layout: default
title: "About Jorge Vilca | Engineering Manager Madrid"
...
<div class="container mx-auto px-6 py-16 max-w-4xl">
    ...
    <div class="mb-12">
      ...
      <div class="text-gray-300 leading-relaxed space-y-4">
        ...
        <ul class="list-disc list-inside space-y-2 text-gray-300">
          ...
          <li>Championing agile methodologies as a Certified Scrum Developer</li>
        </ul>
      </div>
    </div>
    ...
    <!-- Interests & Hobbies -->
    <div class="mb-12">
      <h2 class="text-3xl font-bold text-white mb-6">Beyond Technology</h2>
      <div class="text-gray-300 leading-relaxed space-y-4">
        <p>
    ...
    <!-- Philosophy & Goals -->
    <div class="mb-12">
      <h2 class="text-3xl font-bold text-white mb-6">My Philosophy</h2>
      <div class="text-gray-300 leading-relaxed space-y-4">
        <p>
          I'm a solution-oriented person who believes in the power of technology to solve real-world problems. My goal is to build meaningful solutions that create lasting value — whether that's through writing elegant code, designing robust systems, or empowering teams to do their best work.
        </p>
        <p>
          I'm committed to continuous learning and growth, especially in leadership and emerging technologies. I believe that the intersection of technical depth and people management skills is where the most significant impact happens, and that's where I aim to make my mark.
        </p>
      </div>
    </div>
