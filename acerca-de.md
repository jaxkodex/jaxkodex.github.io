...
<div class="container mx-auto px-6 py-16 max-w-4xl">
    ...
    <div class="mb-12">
      <h2 class="text-3xl font-bold text-white mb-6">Experiencia Profesional</h2>
      <div class="text-gray-300 leading-relaxed space-y-4">
        ...
        <ul class="list-disc list-inside space-y-2 text-gray-300">
          ...
          <li>Promover metodologías ágiles como Certified Scrum Developer</li>
        </ul>
      </div>
    </div>
    ...
    <!-- Interests & Hobbies -->
    <div class="mb-12">
      <h2 class="text-3xl font-bold text-white mb-6">Más Allá de la Tecnología</h2>
      <div class="text-gray-300 leading-relaxed space-y-4">
        <p>
    ...
    <!-- Philosophy & Goals -->
    <div class="mb-12">
      <h2 class="text-3xl font-bold text-white mb-6">Mi Filosofía</h2>
      <div class="text-gray-300 leading-relaxed space-y-4">
        <p>
          Soy una persona orientada a soluciones que cree en el poder de la tecnología para resolver problemas del mundo real. Mi objetivo es construir soluciones significativas que creen valor duradero, ya sea escribiendo código elegante, diseñando sistemas robustos o empoderando equipos para que hagan su mejor trabajo.
        </p>
        <p>
          Estoy comprometido con el aprendizaje y crecimiento continuo, especialmente en liderazgo y tecnologías emergentes. Creo que la intersección entre profundidad técnica y habilidades de gestión de personas es donde ocurre el impacto más significativo, y ahí es donde aspiro a dejar mi huella.
        </p>
      </div>
    </div>
